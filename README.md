...
- [x] **PPT/Pitch deck link** — [View Pitch Deck](https://drive.google.com/file/d/1Eiky8z-ek_HXKSJhUFMJnHdPZzfs6QBn/view?usp=drive_link)
- [x] **Demo video link** — [Watch Demo](https://drive.google.com/file/d/11JkGw3_6I39VOeuiL48h6ASEFs_40RiF/view?usp=drive_link)
...
| [`docs/user-feedback-log.md`](docs/user-feedback-log.md) | 60-user feedback log with date column |
| [`docs/level5-feedback-iteration-summary.md`](docs/level5-feedback-iteration-summary.md) | Feedback-to-iteration map |
| Google Sheet response export | https://docs.google.com/spreadsheets/d/1udP2RBdLfKS0ZtBGFRNgOWgA2LFohOa7oDDTvIlSTAE/edit?usp=drivesdk |
...
| Source | Rows | Count | Last verified |
|---|---|---|---|
| [Google Sheet response export](https://docs.google.com/spreadsheets/d/1udP2RBdLfKS0ZtBGFRNgOWgA2LFohOa7oDDTvIlSTAE/edit?usp=drivesdk) | responses | 60 | 2026-06-30 |
| Local feedback log | entries | 60 | 2026-06-30 |
