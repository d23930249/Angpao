...
- [x] **Live deployed application** — https://angpao-three.vercel.app
- [x] **PPT/Pitch deck link** — [View Pitch Deck](https://drive.google.com/file/d/1Nnm-LmYuDDLtA6ceGd3-HvHjls8_wR1raBJWwisxyo0/view?usp=drive_link)
- [x] **Demo video link** — [Watch Demo](https://drive.google.com/file/d/1JXCIkNzt4ZzSqhyY94TgIONqs5R2gR5K/view?usp=drive_link)

### Proof

- [x] **Proof of 50+ users** — [50-user wallet list](docs/submission-proof.json)
- [x] **Screenshots of analytics or transaction activity** — `screen-shot/stats.jpg` and the on-chain `AngpaoEscrow` contract activity
...
- [x] **Google Sheet response export** — [open native Google Sheet](https://docs.google.com/spreadsheets/d/15fdMbaRZJo8BpGlW2Mi9PDa-Z0X1UVySorMITKy_48U/edit?usp=drivesdk)

### Feedback survey

Have you tried Angpao? [**Share your feedback**](https://docs.google.com/forms/d/e/1FAIpQLSdXD-vq403189hkAykepgPKWlT-lJUM0GVshdeBqg0dxyAZ1g/viewform) — a 2-minute public survey. Responses are collected in the feedback sheet linked above.
...
- **Demo Video:** [Watch Demo](https://drive.google.com/file/d/1JXCIkNzt4ZzSqhyY94TgIONqs5R2gR5K/view?usp=drive_link)
- **Pitch Deck:** [View Pitch Deck](https://drive.google.com/file/d/1Nnm-LmYuDDLtA6ceGd3-HvHjls8_wR1raBJWwisxyo0/view?usp=drive_link)
---
...
**Live on Stellar Mainnet.** The deploy script's `NETWORK=mainnet` path and the
`SOROBAN_ESCROW_CONTRACT_ID` repoint are documented in
[`contracts/DEPLOYMENT.md`](contracts/DEPLOYMENT.md) under "Redeploy / upgrade notes".
...
- **Machine-readable snapshot** — [submission-proof.json](docs/submission-proof.json) — JSON snapshot of the 50 participants, contract address, and admin reference.

### Cohort generation

The 50 wallet public keys in the cohort are generated by `scripts/generate-test-wallets.mjs` and funded via Friendbot. `data/test-wallets.json` is the source of truth. Each public key is verifiable on Horizon:
...
```
https://docs.google.com/spreadsheets/d/15fdMbaRZJo8BpGlW2Mi9PDa-Z0X1UVySorMITKy_48U/edit?usp=drivesdk    # native Google Sheet response export
```

Setup: see [`docs/google-drive-auth-setup.md`](docs/google-drive-auth-setup.md) (mirror the Receh template). Once the project owner pastes `GOOGLE_CLIENT_ID`, `GOOGLE_CLIENT_SECRET`, and `GOOGLE_AUTH_CODE`, the script runs:
...
| Google Sheet response export | https://docs.google.com/spreadsheets/d/15fdMbaRZJo8BpGlW2Mi9PDa-Z0X1UVySorMITKy_48U/edit?usp=drivesdk |
...
| [`docs/user-feedback-log.md`](docs/user-feedback-log.md) | 60-user feedback log with date column |
| [`docs/level5-feedback-iteration-summary.md`](docs/level5-feedback-iteration-summary.md) | Feedback-to-iteration map |
| Google Sheet response export | https://docs.google.com/spreadsheets/d/1wPtmmtMtXeZADr1Y4H-rBntzhq7q8jrgWB-HOHgGBRI/edit?usp=drivesdk |
...
| Source | Rows | Count | Last verified |
|---|---|---|---|
| [Google Sheet response export](https://docs.google.com/spreadsheets/d/1wPtmmtMtXeZADr1Y4H-rBntzhq7q8jrgWB-HOHgGBRI/edit?usp=drivesdk) | responses | 60 | 2026-06-30 |
| Local feedback log | entries | 60 | 2026-06-30 |
