...
export const paymentChainEnum = pgEnum('angpao_payment_chain', PAYMENT_CHAINS);

export const PAYMENT_INTENT_STATUSES = ['awaiting', 'detected', 'failed'] as const;
export type PaymentIntentStatus = (typeof PAYMENT_INTENT_STATUSES)[number];

export const paymentIntentStatusEnum = pgEnum('angpao_payment_intent_status', PAYMENT_INTENT_STATUSES);
