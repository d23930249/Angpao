...
export const withdrawalStatusEnum = pgEnum('angpao_withdrawal_status', WITHDRAWAL_STATUSES);

export const PAYOUT_METHODS = ['bank_deposit', 'cash_pickup'] as const;
export type PayoutMethod = (typeof PAYOUT_METHODS)[number];

export const payoutMethodEnum = pgEnum('angpao_payout_method', PAYOUT_METHODS);

export const MEMO_TYPES = ['text', 'id', 'hash', 'return'] as const;
export type MemoType = (typeof MEMO_TYPES)[number];

export const memoTypeEnum = pgEnum('angpao_withdrawal_memo_type', MEMO_TYPES);
